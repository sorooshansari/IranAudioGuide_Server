...
namespace IranAudioGuide_MainServer.Services
{
    ...
    {
      //  public static readonly string ConnectionString = @"Data Source=DESKTOP-UG1254U;Initial Catalog=iranaud5_db;Integrated Security=True";
        public static readonly string ConnectionString = @"Data Source=(localdb)\MSSQLLocalDB;Initial Catalog=test2;Integrated Security=True";
