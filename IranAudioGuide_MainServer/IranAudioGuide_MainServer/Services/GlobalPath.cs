...
namespace IranAudioGuide_MainServer
{
    public static class GlobalPath
    {
        ...
        public static readonly string ConnectionString = @"Password = l9*Eav61i783!0o; Persist Security Info=True;User ID = iranaud1_admin; Initial Catalog = iranaud1_db; Data Source = 88.99.137.107\MSSQLSERVER2012,51012";
