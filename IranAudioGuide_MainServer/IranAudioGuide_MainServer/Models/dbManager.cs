...
namespace IranAudioGuide_MainServer.Models
{
    ...
    {
        //readonly public static string connString = @"Data Source=(LocalDb)\MSSQLLocalDB;Initial Catalog=iranAudioGuide; Persist Security Info=True; User ID =sa;Password = 123;";
