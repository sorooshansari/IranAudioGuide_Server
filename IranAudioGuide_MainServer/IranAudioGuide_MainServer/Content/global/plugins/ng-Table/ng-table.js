...
angular.module('ngTable').run(['$templateCache', function ($templateCache) {
	...
	$templateCache.put('ng-table/pager.html', '<div class="ng-cloak ng-table-pager" > <div class="ng-table-pager-col">  <div ng-if="params.settings().counts.length" class="ng-table-counts btn-group pull-right"> تعداد نمایش <select ng-options="count for count in params.settings().counts" ng-model="countsme"  ng-init="countsme = params.settings().counts[0]"  ng-change="params.count(countsme)"></select> <span class="info-pageing">   <span class="">صفحه:{{params.page()}}</span><span class=""> تعداد در هر صفحه: {{countsme}} </span> </span></div> </div> <div class="ng-table-pager-col"> <ul class="pagination ng-table-pagination"> <li ng-class="{\'disabled\': !page.active}" ng-repeat="page in pages" ng-switch="page.type"> <a ng-switch-when="prev" ng-click="params.page(page.number)" href="">قبلی</a> <a ng-switch-when="first" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a> <a ng-switch-when="page" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a> <a ng-switch-when="more" ng-click="params.page(page.number)" href="">&#8230;</a> <a ng-switch-when="last" ng-click="params.page(page.number)" href=""><span ng-bind="page.number"></span></a> <a ng-switch-when="next" ng-click="params.page(page.number)" href="">بعدی</a> </li> </ul> </div> </div> ');
}]);
    return app;
}));